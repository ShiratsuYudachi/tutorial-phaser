...
import { InputData } from "./Schema"; // 稍后更新 Schema 导出 InputData
import Matter from "matter-js";
import { GAME_CONFIG, COLLISION_CATEGORIES } from "./Constants";

// 纯逻辑：应用输入力到物体
// 注意：Matter.js 推荐使用力(Force)或速度(Velocity)
export function applyInput(body: Matter.Body, input: InputData) {
